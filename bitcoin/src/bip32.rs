...
impl Xpriv {
    ...
    pub fn encode(&self) -> [u8; 78] {
        ...
        ret[0..4].copy_from_slice(&match self.network {
            ...
            Network::Testnet | Network::Regtest => VERSION_BYTES_TESTNETS_PRIVATE,
        });
        ret[4] = self.depth;
...
impl Xpub {
    ...
    pub fn encode(&self) -> [u8; 78] {
        ...
        ret[0..4].copy_from_slice(&match self.network {
            ...
            Network::Testnet | Network::Regtest => VERSION_BYTES_TESTNETS_PUBLIC,
        });
        ret[4] = self.depth;
        ret[5..9].copy_from_slice(&self.parent_fingerprint[..]);
        ret[9..13].copy_from_slice(&u32::from(self.child_number).to_be_bytes());
...
"dgub8pxikcq7rUy5RBaCfPT1D2UXTkqVnSYt4PitiVJqfGubzv9kfyBQ9JN27SfVyUmBGTdQ6ybfBsu4Thrrdkm2qSbaCexVPRwEKMSxYLP2A41"); // see note below
...
test_path(&secp, Bitcoin, &seed, "m/0h".parse().unwrap(),
    ...
    fn schnorr_broken_privkey_zeros() {
        ...
        let xpriv_str = "dgpv51eADS3spNJh7veMCAiKkjPZevJqLc7Fk8RcZ7otUGJWivyGsXLe2SZWtFePA71UXeGS2Uouo7jb5NjVqH71d1ejQxc2UvJw15x2SD4tn3a";
    ...
    fn schnorr_broken_privkey_ffs() {
        ...
        let xpriv_str = "dgpv51eADS3spNJh7veMCAiKkjPZevJqLc7Fk8RcZ7otUGJWivyGsXLe2SZWtHb8LLTWP4wfAJPchhMb2hLGkPijGiVcCbg8j4zpzjxQvkJddyY";
        Xpriv::from_str(xpriv_str).unwrap();
    }
}
